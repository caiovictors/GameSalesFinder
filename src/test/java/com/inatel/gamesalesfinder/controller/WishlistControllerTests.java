...
public class WishlistControllerTests {
  ...
  // when(loggedUserExists.run()).thenReturn(null);

  // createFlashCardService = new CreateFlashCardService(studentRepository,
  // disciplineRepository, flashCardsRepository, flashCardsForm);
  // ResponseEntity<?> createFlashCardServiceExecution =
  // createFlashCardService.run();

  // assertEquals(createFlashCardServiceExecution.getStatusCode(),
  // HttpStatus.UNAUTHORIZED);
  // assertTrue(((Exceptions)
  // createFlashCardServiceExecution.getBody()).getMessage().equals("Student does
  // not exist"));
  // }
